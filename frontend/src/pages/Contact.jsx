        ...
        <div className="flex flex-col justify-center space-y-8 md:space-y-12">
          <div className="space-y-4 text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start gap-3">
              ...
              <p className="text-yellow-500 font-black tracking-[0.3em] text-[10px] uppercase">Ready to elevate?</p>
            </div>
            <h2 className="text-6xl md:text-8xl lg:text-9xl font-black text-white italic uppercase tracking-tighter leading-[0.9] md:leading-[0.85]">
              Let's <br /> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">Connect</span>
            </h2>
          </div>

          {/* Info Blocks - Stacked on Mobile, Bento on Desktop */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
            <div className="group p-5 md:p-6 rounded-[2rem] bg-white/[0.02] border border-white/5 hover:border-yellow-500/20 transition-all duration-500">
              <p className="text-zinc-600 group-hover:text-yellow-500/50 text-[9px] font-black uppercase tracking-widest mb-1 transition-colors">Location</p>
              <p className="text-zinc-300 font-bold text-sm md:text-base italic uppercase tracking-tighter">Uttar Pradesh, India</p>
            </div>
            <div className="group p-5 md:p-6 rounded-[2rem] bg-white/[0.02] border border-white/5 hover:border-yellow-500/20 transition-all duration-500">
              <p className="text-zinc-600 group-hover:text-yellow-500/50 text-[9px] font-black uppercase tracking-widest mb-1 transition-colors">Status</p>
              <p className="text-zinc-300 font-bold text-sm md:text-base italic uppercase tracking-tighter">Available for Work</p>
            </div>
          </div>
        </div>
          ...
          <div className="relative bg-[#0a0a0c]/80 p-6 md:p-12 rounded-[2.5rem] md:rounded-[3.5rem] border border-white/5 shadow-2xl backdrop-blur-3xl overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 md:gap-7 relative z-10">
              ...
              <div className="space-y-1.5">
                <label className="text-[9px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-4">Authorized Name</label>
                <input 
                  type="text" 
                  name="name" 
              ...
              <div className="space-y-1.5">
                <label className="text-[9px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-4">Communication Line</label>
                <input 
                  type="email" 
                  name="email" 
              ...
              <div className="space-y-1.5">
                <label className="text-[9px] font-black uppercase tracking-[0.2em] text-zinc-500 ml-4">Encrypted Message</label>
                <textarea 
                  name="message" 
